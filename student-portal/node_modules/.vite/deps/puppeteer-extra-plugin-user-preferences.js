...
// node_modules/puppeteer-extra-plugin-user-preferences/index.js
var require_puppeteer_extra_plugin_user_preferences = __commonJS({
  "node_modules/puppeteer-extra-plugin-user-preferences/index.js"(exports, module) {
    var merge2 = require_cjs();
    var { PuppeteerExtraPlugin: PuppeteerExtraPlugin2 } = (init_index_esm(), __toCommonJS(index_esm_exports));
    var Plugin = class extends PuppeteerExtraPlugin2 {
      constructor(opts = {}) {
        super(opts);
      ...
      get requirements() {
        return /* @__PURE__ */ new Set(["runLast", "dataFromPlugins"]);
      }
      get dependencies() {
        return /* @__PURE__ */ new Set(["user-data-dir"]);
      }
      get data() {
        return [
          {
      ...
      get combinedPrefs() {
        return merge2(this._opts.userPrefs, this._userPrefsFromPlugins);
      }
      async beforeLaunch(options) {
        this._userPrefsFromPlugins = merge2.all(
...
export default require_puppeteer_extra_plugin_user_preferences();
...
puppeteer-extra-plugin/dist/index.esm.js:
   ...
   *)
*/
//# sourceMappingURL=puppeteer-extra-plugin-user-preferences.js.map
